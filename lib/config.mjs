// Project-scoped credential store at ~/.config/shopify-admin-cli/credentials.json.
// Used by the `login` command. Env var SHOPIFY_ADMIN_API_KEY always wins when set.
import { readFileSync, writeFileSync, existsSync, mkdirSync, chmodSync } from "node:fs";
import { join } from "node:path";
import { homedir } from "node:os";

const CONFIG_DIR = join(homedir(), ".config", "shopify-admin-cli");
